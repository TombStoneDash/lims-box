...
export default async function ReportsPage() {
  ...
  if (!store.laboratory.available) return <div className="space-y-7"><PageHeading eyebrow="Reporting" title="Released reports" description="Released report state is read from SENAITE." /><LaboratoryUnavailable /></div>;
