...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans">
      <div className="border-b-2 border-amber-400 bg-amber-50 px-6 py-3 text-center text-sm font-bold text-amber-950">
        SYNTHETIC · NON-PRODUCTION · READ-ONLY DATABASE VIEW — use the protected operator sandbox for browser-local rehearsal
      </div>
      <header className="border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <span className="text-xs text-slate-400 uppercase tracking-wide">v1.5 · synthetic prototype</span>
        </div>
      </header>
