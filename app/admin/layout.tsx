        ...
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <nav className="text-sm text-slate-600 flex gap-4">
              ...
              <Link href="/personnel-pack/v15" className="hover:text-slate-900">ISO 15189</Link>
              <Link href="/admin/survey-ready" className="hover:text-slate-900">Survey-ready bundle</Link>
            </nav>
          </div>
          <span className="text-xs text-slate-400 uppercase tracking-wide">v1 + v1.5 · local</span>
        </div>
      </header>
