...
export const corpus: CorpusEntry[] = [
  ...
  {
    id: 'field-scout',
    title: 'What is Field Scout?',
    source: '/field-scout',
    keywords: ['scout', 'water', 'asset', 'assets', 'equipment', 'sampling', 'site', 'bench', 'draft', 'mock'],
    text: 'Field Scout is a mock workflow for authorized asset identification, local draft capture, and human-reviewed transfer into a laboratory record. This preview contains no PHI and no production data.',
  },
  {
    id: 'open-source-license',
    title: 'Is the LIMS engine open source?',
    source: '/partners',
    keywords: ['gpl', 'license', 'licensed', 'licence', 'code', 'github', 'lock-in', 'vendor', 'engine'],
    text: "SENAITE is released under the GPL license, so the LIMS engine LIMS BOX runs on is open source from top to bottom — you can read the code RidingBytes maintains yourself rather than take a vendor's word for it.",
  },
  {
    id: 'case-study-illustrative',
    title: 'Is the case study a real customer?',
    source: '/case-study',
    keywords: ['case', 'study', 'customer', 'customers', 'scenario', 'illustrative', 'hypothetical', 'testimonial', 'reference', 'fictional'],
    text: 'This is a hypothetical, illustrative composite scenario. It does not describe an actual LIMS BOX customer; the lab, people, timeline, and results below are fictional examples.',
  },
  {
    id: 'implementation-fee',
    title: 'Is there an implementation fee?',
    source: '/pricing',
    keywords: ['implementation', 'fees', 'upfront', 'onboarding', 'configuration', 'subscription', 'included', 'includes'],
    text: 'No. Zero implementation fees. Your subscription includes setup, configuration, and onboarding support. Growth and Enterprise plans include a dedicated onboarding call.',
  },
  {
    id: 'plan-changes',
    title: 'Can I upgrade or downgrade my plan?',
    source: '/pricing',
    keywords: ['upgrade', 'downgrade', 'switch', 'tier', 'tiers', 'billing', 'cycle', 'penalties', 'penalty'],
    text: 'Yes. Upgrade instantly, downgrade at the end of your billing cycle. No penalties either way.',
  },
  {
    id: 'clinical-labs',
    title: 'How does LIMS BOX help clinical labs?',
    source: '/clinical',
    keywords: ['clinical', 'lis', 'vendor', 'portal', 'unreachable', 'folders', 'hospital', 'downtime', 'gaps'],
    text: 'When your LIS goes down, when your vendor portal is unreachable, when a survey lands next month and your personnel records live in three folders — LIMS BOX is the local-first documentation layer that fills the gaps.',
  },
  {
    id: 'environmental-labs',
    title: 'How does LIMS BOX help environmental labs?',
    source: '/environmental',
    keywords: ['environmental', 'nelap', 'truck', 'office', 'calibration', 'building', 'wastewater', 'soil', 'outside'],
    text: 'When your sample comes off a truck in the field, when the LIMS only works at the office, when a NELAP audit asks for the calibration record you printed in 2023 — LIMS BOX is the local-first documentation layer for environmental labs that work outside the building.',
  },
  {
    id: 'synthetic-demo',
    title: 'Is the demo connected to real lab data?',
    source: '/clinical',
    keywords: ['synthetic', 'fictional', 'dashboard', 'phi', 'charts', 'sandbox', 'fake', 'explore'],
    text: 'Explore a fictional SENAITE-based lab dashboard — sample status, QC charts, equipment calibration, and training records. Synthetic data only. No PHI, no customer data, and not connected to any live production system.',
  },
];
