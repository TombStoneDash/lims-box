          ...
          <nav aria-label="Footer" className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><Link href="/case-study" className="text-slate-600 dark:text-slate-300 hover:text-lab-teal transition-colors">Illustrative Scenario</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><Link href="/for/clinical-labs" className="text-slate-600 dark:text-slate-300 hover:text-lab-teal transition-colors">Clinical Labs: Personnel Records</Link></li>
                <li><Link href="/for/diagnostics-labs" className="text-slate-600 dark:text-slate-300 hover:text-lab-teal transition-colors">Diagnostics Labs: Personnel Records</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><Link href="/evidence" className="text-slate-600 dark:text-slate-300 hover:text-lab-teal transition-colors">Evidence Matrix</Link></li>
